...
- Public store release still needs final app icon/splash PNG exports, store screenshots, signing, privacy/support/account deletion URLs, and final device QA.
...
5. Prepare final public privacy/support/account deletion URLs.
