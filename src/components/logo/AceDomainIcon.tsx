  ...
  return (
    ...
    >
      ...
      <svg className="relative h-[78%] w-[78%]" viewBox="0 0 100 100" role="img" aria-hidden="true">
        <defs>
          <linearGradient id="ace-metal" x1="18" x2="82" y1="10" y2="92" gradientUnits="userSpaceOnUse">
            <stop stopColor="#FFF7D2" />
            <stop offset="0.28" stopColor="#D6DBE7" />
            <stop offset="0.58" stopColor="#C09135" />
            <stop offset="1" stopColor="#5E7DFF" />
          </linearGradient>
          <linearGradient id="ace-ring" x1="12" x2="88" y1="50" y2="50" gradientUnits="userSpaceOnUse">
        ...
        <ellipse cx="50" cy="51" rx="39" ry="17" fill="none" stroke="url(#ace-ring)" strokeWidth="3.5" transform="rotate(-18 50 51)" />
        <path
